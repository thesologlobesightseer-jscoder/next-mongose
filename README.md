...
- `MONGODB_USER` should be the MongoDB connection string's user part you got from step 1.
- `MONGODB_PASS` should be the MongoDB connection string's password part you got from step 1.
- `MONGODB_HOST` should be the MongoDB connection string's host part you got from step 1.
- `MONGODB_DB` should be the MongoDB database in which you want to store/retrieve the data.
